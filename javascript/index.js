  ...
  getInstruction("mashedPotatoes", 2, (step) => {
    ...
    getInstruction("mashedPotatoes", 3, (step) => {
      ...
      getInstruction("mashedPotatoes", 4, (step) => {
        document.querySelector("#mashedPotatoes").innerHTML += `<li>${step}</li><li>Mashed potatoes are ready!</li>`;
        document.querySelector("#mashedPotatoesImg").removeAttribute("hidden");
       }, (err) => console.log(err));
     }, (err) => console.log(err));
   }, (err) => console.log(err));
...
async function makeBroccoli() {
  ...
  document.querySelector("#broccoli").innerHTML += `<li>Broccoli is bready!</li>`
...
Promise.all(arr).then((val) => {val.forEach((e) => {
